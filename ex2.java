/* CS 0401 Fall 2018 Java Example 2
...
public class ex2
{
    public static void main (String [] args) {
        ...
        j = 30;  // In Java, method variables (the ones shown here) must be
          ...
          //i = "1234";	// This is also not allowed.  Even though the String looks
          				// like an int it is still a String
          i = Integer.parseInt("1234");  // This is legal.  We will talk more about
          				// Integer and the parseInt() method later in the term.
